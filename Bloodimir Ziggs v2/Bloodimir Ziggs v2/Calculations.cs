...
namespace Bloodimir_Ziggs_v2
{
    internal class Calculations
    {
        ...
        {
            return Ziggs.CalculateDamageOnUnit(target, DamageType.Magical,
                (new float[] {0, 70, 105, 140, 175, 210}[Program.W.Level] +
        ...
        {
            return Ziggs.CalculateDamageOnUnit(target, DamageType.Magical,
                (new float[] {0, 40, 65, 90, 115, 140}[Program.E.Level] +
                 (0.30f*Ziggs.FlatMagicDamageMod)) + (new float[] {0, 16, 26, 36, 46, 56}[Program.E.Level] +
