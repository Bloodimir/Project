...
using xClient.KuuhakuÇekirdek.NetSerializer.TypeSerializers;

namespace xClient.KuuhakuÇekirdek.NetSerializer
{
	public class Serializer
	{
		...
		void GenerateDynamic(Dictionary<Type, TypeData> map)
		{
			...
			foreach (var kvp in map)
			{
				...
				td.WriterMethodInfo = Yardımcılar.GenerateDynamicSerializerStub(type);
				td.ReaderMethodInfo = Yardımcılar.GenerateDynamicDeserializerStub(type);
			}
