...
namespace xServer.KuuhakuCekirdek.Eylemler
{
    public static partial class Eylemİşleyicisi
    {
        ...
        {
            if (client.Value == null || client.Value.FrmFm == null || packet.DriveDisplayName == null ||
                packet.RootDirectory == null)
                return;
        ...
        public static void HandleGetStartupItemsResponse(Client client, GetStartupItemsResponse packet)
        {
            ...
            foreach (var item in packet.StartupItems)
            {
                ...
                var temp = preparedItem.Split(new[] { "||" }, StringSplitOptions.None);
